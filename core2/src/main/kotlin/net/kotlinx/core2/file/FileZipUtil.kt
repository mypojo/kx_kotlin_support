...
//    fun unzipWithFileName(zip: File?, dir: File, outputFileNm: String) {
//        if (!dir.exists()) dir.mkdirs()
//        require(dir.isDirectory) { dir.toString() + "is not directory" }
//        val buffer = ByteArray(BUFFER_SIZE)
//        var fileIn: InputStream? = null
//        try {
//            fileIn = FileInputStream(zip)
//            val zipStream = ZipInputStream(fileIn)
...
//        } finally {
//            IOUtil.closeSilently(fileIn)
//        }
//    }

//    /**
//     * 압축된 파일의 해시 리턴
//     * zip 파일 내의 img 파일 중복 여부 검사 등
//     */
//    fun hash(file: File): List<Map.Entry<String, String>> {
//        val list: MutableList<Map.Entry<String, String>> = ArrayList()
//        val theFile: InputStream = FileInputStream(file)
//        val stream = ZipInputStream(theFile)
//        var entry: ZipEntry
//        while (stream.nextEntry.also { entry = it } != null) {
//            val md = MessageDigest.getInstance("MD5")
//            val dis = DigestInputStream(stream, md)
//            val buffer = ByteArray(1024)
//            var read = dis.read(buffer)
//            while (read > -1) {
//                read = dis.read(buffer)
//            }
//            val hex: String = Hex.encodeHexString(dis.messageDigest.digest())
//            list.add(java.util.Map.entry(hex, entry.name))
//        }
//        return list
//    }
}
