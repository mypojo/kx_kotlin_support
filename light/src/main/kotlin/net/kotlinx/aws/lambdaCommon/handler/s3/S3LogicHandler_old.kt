...
//
//    /** 로컬 작업공간 */
//    private val workDir = File(AwsInstanceTypeUtil.INSTANCE_TYPE.root, S3LogicHandler_old::class.simpleName).apply { mkdirs() }
//
//    /** 직접 호출 */
