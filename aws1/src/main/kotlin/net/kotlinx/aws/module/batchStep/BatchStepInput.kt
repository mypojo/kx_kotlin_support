...
class BatchStepInput {
    ...
    fun toJson(): String = KosonSet.KSON_OTHER.encodeToString(this)

    companion object {

        fun parse(json: String): BatchStepInput = KosonSet.KSON_OTHER.decodeFromString<BatchStepInput>(json)
