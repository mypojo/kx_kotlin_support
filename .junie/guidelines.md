...
- 테스트 코드의 위치 경로는 각 프로젝트의 의 -> 'src/test/kotlin' 으로 통일 해주세요
- 반드시 kotest를 사용해야 합니다 ex) class TeamAdvUpdatorTest : BeSpecHeavy() { ...
- mock 객체를 사용할 필요 없고 해당 객체를 koin 등으로 가져와서 직접 실행하게 해줘
