...
class CdkSfn : CdkInterface {
    ...
    //==================================================== 단축 ======================================================
    fun lambda(id: String, name: String, block: CdkSfnLambda.() -> Unit = {}) = CdkSfnLambda(this, id, name).apply(block).convert()
    fun batch(id: String, name: String, block: CdkSfnBatch.() -> Unit = {}) = CdkSfnBatch(this, id, name).apply(block).convert()
    fun wait(id: String, name: String, block: CdkSfnWait.() -> Unit = {}) = CdkSfnWait(this, id, name).apply(block).convert()
    fun choice(id: String, name: String, block: CdkSfnChoice.() -> Unit = {}) = CdkSfnChoice(this, id, name).apply(block).convert()
    fun mapInline(id: String, name: String, block: CdkSfnMapInline.() -> Unit = {}) = CdkSfnMapInline(this, id, name).apply(block).convert()
    //==================================================== 작업 ======================================================
